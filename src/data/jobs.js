...
export const JOBS = {
  ...
  warrior:  { name: '전사', spd: 9, role: 'dps', mana: 100, skills: ['warrior_cleave', 'warrior_heavy', 'melee_strike'],
  ...
  mage:     { name: '마법사', spd: 8, role: 'dps', mana: 120, skills: ['mage_nuke', 'mage_focus', 'ranged_strike'],
