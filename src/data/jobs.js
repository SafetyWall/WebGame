...
export const JOBS = {
  ...
  warrior:  { name: '전사', spd: 120, role: 'dps', mana: 100, def: 40, skills: ['warrior_cleave', 'warrior_heavy', 'warrior_might', 'warrior_crush', 'melee_strike'],
  ...
  mage:     { name: '마법사', spd: 110, role: 'dps', mana: 120, skills: ['mage_nuke', 'mage_focus', 'mage_frost', 'mage_lightning', 'ranged_strike'],
