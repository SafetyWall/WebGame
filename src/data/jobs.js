...
export const JOBS = {
  ...
  warrior:  { name: '전사', spd: 9, role: 'dps', mana: 100, def: 40, skills: ['warrior_cleave', 'warrior_heavy', 'warrior_might', 'warrior_crush', 'melee_strike'],
  ...
  guardian: { name: '가디언', spd: 5, role: 'tank', mana: 100, def: 100, skills: ['guardian_sunder', 'guardian_barrier', 'guardian_thorns', 'guardian_guard', 'guardian_strike'],
