...
export const JOBS = {
  ...
  warrior:  { name: '전사', spd: 120, role: 'dps', mana: 100, def: 40, skills: ['warrior_cleave', 'warrior_heavy', 'warrior_crush', 'guardian_barrier', 'melee_strike'],
  ...
  mage:     { name: '마법사', spd: 90, role: 'dps', mana: 120, skills: ['mage_nuke', 'mage_focus', 'mage_frost', 'mage_lightning', 'ranged_strike'],
  ...
  guardian: { name: '가디언', spd: 70, role: 'tank', mana: 100, def: 100, skills: ['guardian_sunder', 'guardian_barrier', 'guardian_thorns', 'guardian_guard', 'guardian_strike'],
  ...
  priest:   { name: '사제', spd: 100, role: 'heal', mana: 120, skills: ['priest_heal', 'priest_agi', 'priest_party_buff', 'priest_party_heal', 'holy_bolt'],
    levels: { 1: { hp: 95, atk: 12, heal: 30 }, 2: { hp: 114, atk: 14, heal: 36 }, 3: { hp: 137, atk: 16, heal: 43 }, 4: { hp: 164, atk: 20, heal: 52 }, 5: { hp: 197, atk: 24, heal: 62 },
              6: { hp: 236, atk: 28, heal: 74 }, 7: { hp: 284, atk: 34, heal: 89 }, 8: { hp: 340, atk: 42, heal: 107 }, 9: { hp: 409, atk: 50, heal: 129 }, 10: { hp: 490, atk: 60, heal: 154 } } },
  rogue:    { name: '도적', spd: 150, role: 'dps', mana: 100, skills: ['rogue_bleed', 'rogue_haste', 'rogue_double', 'rogue_pierce', 'melee_strike'],
  ...
  archer:   { name: '궁수', spd: 120, role: 'dps', mana: 100, skills: ['archer_aim', 'archer_rapid', 'archer_pierce', 'archer_bind', 'ranged_strike'],
