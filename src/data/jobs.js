...
export const JOBS = {
  ...
  warrior:  { name: '전사', spd: 9, role: 'dps', mana: 100, skills: ['warrior_cleave', 'melee_strike'],
  ...
  mage:     { name: '마법사', spd: 8, role: 'dps', mana: 120, skills: ['mage_nuke', 'ranged_strike'],
  ...
  guardian: { name: '가디언', spd: 5, role: 'tank', mana: 100, skills: ['guardian_taunt', 'guardian_strike'],
  ...
  priest:   { name: '사제', spd: 7, role: 'heal', mana: 120, skills: ['priest_hot', 'basic_heal'],
