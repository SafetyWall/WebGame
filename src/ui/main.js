...
app.addEventListener('click', (ev) => {
  ...
  switch (btn.dataset.action) {
    ...
    case 'learnSkill':   state = run.learnSkill(state, i, btn.dataset.skill); break
    case 'levelupSkill': state = run.levelUpSkill(state, i, btn.dataset.skill); break
    case 'reorderParty': state = run.reorderParty(state, i, Number(btn.dataset.dir)); break
